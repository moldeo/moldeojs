...
export class MoldeojsViewComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //this.MoldeoCS.Init({ "consoleconfig": "./assetsmolrepos/moldeoorg/dante/pajarosdefuego/pajaros_de_fuegoX.mol" } );
    //this.MoldeoCS.Init({ "consoleconfig": "./assetsmolrepos/moldeoorg/fabri/EsferaEspiral/EspiralEsfera.mol" } );
    //this.MoldeoCS.Init({ "consoleconfig": "./assetsmolrepos/samples/SimpleProject/simple_projectX.mol" } );
    //this.MoldeoCS.Init({ "consoleconfig": "./assetsmolrepos/samples/CicloDelAgua/CicloDelAguaX.mol" } );
