...
export class MoDefaultComponent implements OnInit {
  ...
  @ViewChild('moMobEdit', {static: false} ) moMobEdit;
  @ViewChild('moMobEditTitle', {static: false} ) moMobEditTitle;
  @ViewChild('moMobEditName', {static: false} ) moMobEditName;
  @ViewChild('moMobEditType', {static: false} ) moMobEditType;
  @ViewChild('moMob', {static: false} ) moMob;
